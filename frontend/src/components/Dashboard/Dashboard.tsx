        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
            <div className="text-center">
              <div className="text-4xl font-bold mb-3 text-gray-900 group-hover:text-blue-600 transition-colors duration-300">{getStatusCount('Bookmarked')}</div>
              <div className="text-sm font-semibold uppercase tracking-wider text-gray-600 group-hover:text-gray-900 transition-colors duration-300">Bookmarked</div>
            </div>
          </div>
          <div className="bg-yellow-100 border border-yellow-200 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
            <div className="text-center">
              <div className="text-4xl font-bold mb-3 text-yellow-800 group-hover:text-yellow-900 transition-colors duration-300">{getStatusCount('Applying')}</div>
              <div className="text-sm font-semibold uppercase tracking-wider text-yellow-700 group-hover:text-yellow-800 transition-colors duration-300">Applying</div>
            </div>
          </div>
          <div className="bg-blue-100 border border-blue-200 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
            <div className="text-center">
              <div className="text-4xl font-bold mb-3 text-blue-800 group-hover:text-blue-900 transition-colors duration-300">{getStatusCount('Applied')}</div>
              <div className="text-sm font-semibold uppercase tracking-wider text-blue-700 group-hover:text-blue-800 transition-colors duration-300">Applied</div>
            </div>
          </div>
          <div className="bg-purple-100 border border-purple-200 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
            <div className="text-center">
              <div className="text-4xl font-bold mb-3 text-purple-800 group-hover:text-purple-900 transition-colors duration-300">{getStatusCount('Interviewing')}</div>
              <div className="text-sm font-semibold uppercase tracking-wider text-purple-700 group-hover:text-purple-800 transition-colors duration-300">Interviewing</div>
            </div>
          </div>
          <div className="bg-green-100 border border-green-200 rounded-2xl p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
            <div className="text-center">
              <div className="text-4xl font-bold mb-3 text-green-800 group-hover:text-green-900 transition-colors duration-300">{getStatusCount('Accepted')}</div>
              <div className="text-sm font-semibold uppercase tracking-wider text-green-700 group-hover:text-green-800 transition-colors duration-300">Accepted</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-8 shadow-lg">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-1 bg-gray-100 rounded-full p-1 shadow-sm">
                <Button 
