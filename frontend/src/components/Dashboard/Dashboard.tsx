        ...
        <div className="w-full px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex items-center space-x-8">
              ...
              <a href="#" className="text-muted-foreground hover:text-blue-600 transition-colors font-medium">Statistics</a>
              <a href="#" className="text-muted-foreground hover:text-blue-600 transition-colors font-medium">Job Matcher</a>
              <a href="#" className="text-muted-foreground hover:text-blue-600 transition-colors font-medium">AI Resume Builder</a>
